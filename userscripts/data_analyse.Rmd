...
```{r}
#tree2 <- C5.0(classe ~ sexe + situationFamiliale + X2eme.voiture + nbEnfantsAcharge, data)
#plot(tree2, type="simple")
```


```{r}
tree3 <- tree(classe ~ sexe + situationFamiliale + X2eme.voiture + nbEnfantsAcharge, data)
```
```{r}
#plot(tree3)
#text(tree3, pretty=0)
